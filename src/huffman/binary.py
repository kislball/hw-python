"""
Этот файл содержит функции для сжатия какой-либо последовательности бит алгоритмом Хафмана,
при этом сохраняя словарь и сами сжатые данные в одну последовательность байт.
